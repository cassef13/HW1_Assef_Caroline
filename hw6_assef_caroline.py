# -*- coding: utf-8 -*-
"""HW6_Assef_Caroline.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/17svwVgKi6O5sxd0-n3xVVtq6-BNSBDG_
"""
...
barplot(height = df[c(1, 4, 5), 2], names.arg = df[c(1, 4, 5), 1], col = c("pink", "red", "orange"))

val <- c(min(df[["salary"]]), max(df[["salary"]]), median(df[["salary"]]))
labels <- c("minimum", "maximum", "median")
pie(val, labels, col = c("pink", "red", "orange"))